...
from algo.measurements import Measurements, calc_measurement_non_unit_cell_kagome_tn
from containers import Config
from tensor_networks import KagomeTNArbitrary


simple_update_data_folder = Path(base_folder)/"data"/"simple_update_results"
simple_update_data_folder = simple_update_data_folder.__str__()+foldersep
